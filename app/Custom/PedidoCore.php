    ...
    public function subirPedidoSiesa($pedido, $detallesPedido)
    {
        if (count($detallesPedido) > 0) {
            ...
            if (!empty($datosClienteSiesa)) {
                $importar = true;
                $cadena = "";
                $cadena .= str_pad(1, 7, "0", STR_PAD_LEFT) . "00000001007\n"; // Linea 1
                ...
                $cadena .= str_pad($contador, 7, "0", STR_PAD_LEFT) . "99990001007";
                ...
                if (!$this->existePedidoSiesa('7', $pedido['tipo_documento'], str_pad($pedido['numero_pedido'], 15, "Y", STR_PAD_LEFT)) && $importar === true) {
                ...
                } elseif ($this->existePedidoSiesa('7', $pedido['tipo_documento'], str_pad($pedido['numero_pedido'], 15, "Y", STR_PAD_LEFT))) {
